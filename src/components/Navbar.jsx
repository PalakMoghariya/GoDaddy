          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              ...
              <li className="nav-item">
                <a className="nav-link" href="#">Website & Hosting</a>
              </li>
              <li className='nav-item'>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><a className="dropdown-item" href="#">SSL Certificates</a></li>
                  <li><a className="dropdown-item" href="#">Managed SSL Certificate</a></li>
              ...
              <li className='nav-item'>
                <a href="#" className='nav-link'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-cart2 hover:tw-bg-transparent" viewBox="0 0 16 16">
